...
player_api_ids = pandas.read_excel('./nhl-stats.xls', 'PlayerApiIds')
team_api_ids = pandas.read_excel('./nhl-stats.xls', 'TeamApiIds')
draft = pandas.read_excel('./nhl-stats.xls', 'Draft')
season1920 = pandas.read_excel('./nhl-stats.xls', 'Season2019')
season2021 = pandas.read_excel('./nhl-stats.xls', 'Season2020')
season2122 = pandas.read_excel('./nhl-stats.xls', 'Season2021')
